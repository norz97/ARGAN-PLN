            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="<?= base_url() ?>C_unit/edit">
                        <input type="text" name="id_unit" value="<?= $data["id_unit"]?>" hidden />
                            <!-- Card Icon -->
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" id="namaunit" name="nm_unit" value="<?= $data["nm_unit"]?>" placeholder="Masukan nama unit..">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Label Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" id="almtunit" name="alamat" value="<?= $data["alamat"]?>" placeholder="Masukan alamat unit..">
                                            <br>
