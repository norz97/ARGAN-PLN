                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <!-- Toolbar -->
                            <div class="toolbar">
                                <a href="<?= base_url() ?>C_unit/create" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-fw"></i> Tambah Data</a>
                            </div>
                            <!-- End Toolbar -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-actions">
                                                <a href="<?= base_url() ?>C_unit/update/<?= $data['id_unit']?>" class="btn btn-info btn-fill"><i class="fa fa-pencil"></i> Edit</a>
                                                <a href="<?= base_url() ?>C_unit/deletedata/<?= $data['id_unit']?>" 
                                                class="btn btn-danger btn-fill btn-delete" data-toggle="confirmation" data-title="Hapus Data?" data-singleton="true">
