            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="<?= base_url() ?>C_cp_unit/edit">
                        <input type="text" name="id_cp" value="<?= $data["id_cp"]?>" hidden />
                            <!-- Card Icon -->
                            ...
                            <div class="card-content">
                                ...
                                <!-- Label Input -->
                                <div class="row">
                                    <label class="col-sm-2 label-on-left" for="namacp">Nama CP</label>
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" id="namacp" name="nm_cp" value="<?= $data["nm_cp"]?>" placeholder="Masukan nama CP..">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Label Input -->
                                <!-- Label Input -->
                                <div class="row">
                                    <label class="col-sm-2 label-on-left" for="emailunt">Email</label>
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="email" class="form-control" id="emailunt" name="email" value="<?= $data["email"]?>" placeholder="Masukan alamat email..">
                                            <br>
