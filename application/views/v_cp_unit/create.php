        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="<?= base_url() ?>C_cp_unit/create">
                            <!-- Card Icon -->
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" id="namacp" name="nm_cp" required placeholder="Masukan contact person..">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Label Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="email" class="form-control" id="emailunt" name="email" required placeholder="Masukan alamat email..">
                                            <br>
