                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <!-- Toolbar -->
                            <div class="toolbar">
                                <a href="<?= base_url() ?>C_user_provider/create" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-fw"></i> Tambah Data</a>
                            </div>
                            <!-- End Toolbar -->
                                ...
                                <table id="datatables" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data['nm_uprov'];?></td>
                                            <td><?php echo $data['email'];?></td>
                                            <td><?php echo $data['nm_gprov'];?></td>
                                            <td class="text-center td-actions">
                                                <a href="<?= base_url() ?>C_user_provider/update/<?= $data['id_uprov']?>"
                                                class="btn btn-info btn-fill">
                                                <i class="fa fa-pencil"></i> Edit
                                                </a>

                                                <a href="<?= base_url() ?>C_user_provider/deletedata/<?= $data['id_uprov']?>" 
                                                class="btn btn-danger btn-fill" onclick="demo.showNotification('top','right')>
