            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="<?= base_url() ?>C_group_provider/edit">
                        <input type="text" name="id_gprov" value="<?= $data["id_gprov"]?>" hidden />
                            <!-- Card Icon -->
                            ...
                            <div class="card-content">
                                ...
                                <!-- Label Input -->
                                <div class="row">
                                    <label class="col-sm-2 label-on-left" for="nm_gprov">Group Provider</label>
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" id="nm_gprov" name="nm_gprov" value="<?= $data["nm_gprov"]?>" placeholder="Masukan Group Provider..">
                                            <br>
