                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <!-- Card Title -->
                            <h4 class="card-title">Group Provider</h4>
                            <!-- End Card Title -->
                            <hr>
                            <!-- Toolbar -->
                            <div class="toolbar">
                                <a href="<?= base_url() ?>C_group_provider/create" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-fw"></i> Tambah Data</a>
                            </div>
                            <!-- End Toolbar -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-actions">
                                                <a href="<?= base_url() ?>C_group_provider/update/<?= $data['id_gprov']?>"
                                                class="btn btn-info btn-fill">
                                                <i class="fa fa-pencil"></i> Edit
                                                </a>

                                                <a href="<?= base_url() ?>C_group_provider/deletedata/<?= $data['id_gprov']?>" 
