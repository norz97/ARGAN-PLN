        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="<?= base_url() ?>C_group_provider/create">
                            <!-- Card Icon -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" id="nm_gprov" name="nm_gprov" required placeholder="Masukan Group Provider..">
                                            <br>
