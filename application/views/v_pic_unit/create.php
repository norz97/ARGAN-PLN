        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <!-- Form -->
                        <form role="form" method="post" class="form-horizontal" action="?= base_url() ?>C_pic_unit/create">
                            <!-- Card Icon -->
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" id="namapic" name="nm_pic" required placeholder="Masukan nama PIC..">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Label Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" id="notelp" name="no_telp" required placeholder="Masukan nomor telepon..">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Label Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="email" class="form-control" id="emailpic" name="email" required placeholder="Masukan alamat email..">
                                            <br>
